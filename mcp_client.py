...
and wires them into a Claude conversation loop with streaming.
...
How the client-server-Claude flow works:
    ...
    3. CHAT LOOP (per user message):
       ...
       b. Claude returns either a text response or tool_use blocks.
...
class FeastMCPClient:
    ...
    async def chat(self, user_message: str) -> str:
        ...
        for _ in range(MAX_ITERATIONS):
            ...
            # the full stream and get the final message.
